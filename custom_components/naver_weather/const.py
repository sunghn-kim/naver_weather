...
WIND_SPEED = ["Wind_Speed", "날씨 - 현재 풍속", UnitOfSpeed.METERS_PER_SECOND, "mdi:weather-windy", ""]
WIND_DIR = ["Wind_Direction", "날씨 - 현재 풍향", "", "mdi:windsock", ""]

RAINFALL = ["Precipitation", "날씨 - 시간당 강수량", UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR, "mdi:weather-pouring", ""]

UV = ["Ultraviolet_Index", "날씨 - 자외선 지수", "", "mdi:weather-sunny-alert", ""]
UV_GRADE = ["Ultraviolet_Level", "날씨 - 자외선 수준", "", "mdi:weather-sunny-alert", ""]

UDUST = ["Ultrafine_Dust", "날씨 - 초미세먼지", "μg/m³", "mdi:blur-linear", SensorDeviceClass.PM25]
NDUST = ["Fine_Dust", "날씨 - 미세먼지", "μg/m³", "mdi:blur", SensorDeviceClass.PM25]
UDUST_GRADE = ["Ultrafine_Dust_Level", "날씨 - 초미세먼지 수준", "", "mdi:blur-linear", ""]
NDUST_GRADE = ["Fine_Dust_Level", "날씨 - 미세먼지 수준", "", "mdi:blur", ""]

OZON = ["Ozon", "날씨 - 오존", CONCENTRATION_PARTS_PER_MILLION, "mdi:alpha-o-circle", ""]
OZON_GRADE = ["Ozon_Level", "날씨 - 오존 수준", "", "mdi:alpha-o-circle", ""]

CO  = ["Carbon_Monoxide",  "날씨 - 일산화탄소", CONCENTRATION_PARTS_PER_MILLION, "mdi:molecule-co", ""]
SO2 = ["Sulfur_Dioxide", "날씨 - 아황산가스", CONCENTRATION_PARTS_PER_MILLION, "mdi:alpha-s-circle", ""]
NO2 = ["Nitrogen_Dioxide", "날씨 - 이산화질소", CONCENTRATION_PARTS_PER_MILLION, "mdi:alpha-n-circle", ""]
CAI = ["CAI_Index", "날씨 - 통합대기환경지수",   "", "mdi:alpha-c-circle", ""]
