...
CO  = ["Carbon_Monoxide",  "날씨 - 일산화탄소", CONCENTRATION_PARTS_PER_MILLION, "mdi:molecule-co", SensorDeviceClass.CO]
...
CAI = ["CAI_Index", "날씨 - 통합대기환경지수",   "", "mdi:alpha-c-circle", SensorDeviceClass.AQI]
